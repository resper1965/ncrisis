...
export const TelaUploadZIP: React.FC = () => {
    ...
    <div>
      ...
      >
        ...
        <h3 style={{
          ...
          {dragActive ? 'Solte o arquivo ZIP aqui' : 'Arraste um arquivo ZIP ou clique para selecionar'}
        </h3>
      ...
      {isScanning && (
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ color: '#E0E1E6', fontSize: '14px', fontWeight: '500' }}>
              Analisando conteúdo e detectando PII...
            </span>
            <span style={{ color: '#A5A8B1', fontSize: '14px' }}>
              {scanProgress}%
            </span>
          ...
          <p style={{
            ...
            Verificando vírus e extraindo arquivos...
          </p>
        </div>
      )}
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <span style={{ color: '#A5A8B1', fontSize: '14px' }}>
              Verificação antivírus com ClamAV
            </span>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <span style={{ color: '#A5A8B1', fontSize: '14px' }}>
              Extração segura com proteção contra zip bombs
            </span>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <span style={{ color: '#A5A8B1', fontSize: '14px' }}>
              Detecção de PII (CPF, CNPJ, Email, Telefone)
            </span>
          </div>
        </div>
      </div>
